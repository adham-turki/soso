    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="text-center mb-20">
          <h2 className="text-6xl md:text-7xl font-black text-secondary mb-6 drop-shadow-lg">{t('vegetables.title')}</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          <div className="bg-black/30 backdrop-blur-md rounded-3xl p-10 border-2 border-secondary/30 shadow-2xl">
            <h3 className="text-4xl font-black text-secondary mb-8">{t('vegetables.heading')}</h3>
            <p className="text-xl text-secondary mb-6 leading-relaxed font-medium">
          ...
          <div className="relative group">
            <div className="absolute -inset-6 bg-secondary/40 rounded-3xl blur-3xl group-hover:bg-secondary/60 transition-all duration-500"></div>
            <img
              src={vegetablessections}
              alt={t('vegetables.title')}
              className="relative rounded-3xl shadow-2xl transform group-hover:scale-105 transition-transform duration-500 border-4 border-secondary/40 w-full h-auto"
            />
          </div>
        </div>
      </div>
