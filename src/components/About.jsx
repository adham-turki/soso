    ...
    <section id="about" className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="text-center mb-20">
          <h2 className="text-6xl md:text-7xl font-black text-secondary mb-6 drop-shadow-lg">{t('about.title')}</h2>
          <div className="w-32 h-2 bg-secondary mx-auto shadow-lg"></div>
        </div>
        <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          <div className="bg-black/30 backdrop-blur-md rounded-3xl p-8 border-2 border-secondary/30 shadow-2xl">
            ...
            <div className="mt-8 space-y-6">
              <div className="flex items-center gap-4 bg-secondary/20 p-4 rounded-xl">
                ...
                <p className="text-lg font-bold text-secondary">{t('about.location')}</p>
              </div>
              <div className="flex items-center gap-4 bg-secondary/20 p-4 rounded-xl">
                <div className="w-4 h-4 bg-secondary rounded-full shadow-lg"></div>
                <p className="text-lg font-bold text-secondary">{t('about.phone')}</p>
              </div>
            </div>
          </div>
          <div className="relative group">
            <div className="absolute -inset-4 bg-secondary/30 rounded-3xl blur-2xl group-hover:bg-secondary/50 transition-all duration-500"></div>
            <img
              src={supermarket2}
              alt={t('about.title')}
