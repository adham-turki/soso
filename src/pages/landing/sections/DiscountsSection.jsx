      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {discounts.map((discount, idx) => (
            <div
              key={idx}
              className={`group relative overflow-hidden rounded-2xl border-2 border-secondary/20 hover:border-secondary transition-all duration-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
